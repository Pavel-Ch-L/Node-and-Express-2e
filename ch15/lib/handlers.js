...
// **** Обработчик для форм отправляемых браузером
exports.newsletterSignup = (req, res) => {
  // Предоставляем CSRF значение
...
// **** Завершение обработчика для форм отправляемых браузером
...
// Создаем дирректорию для фотографий (если еще не создана)
...
// **** Обработчик для fetch/JSON форм 
exports.newsletter = (req, res) => {
  // Предоставляем значение CSRF
...
// **** Завершение обработчика fetch/JSON форм
